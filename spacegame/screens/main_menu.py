import pygame
from spacegame.ui.ui import Button, UI_BG_MAINMENU_IMG
...
def main():
    ...
    title_surf = title_font.render("Space Game", True, (255, 255, 255))
    ...
    while running:
        ...
        try:
            screen.blit(UI_BG_MAINMENU_IMG, (0, 0))
        except Exception:
            # Fallback: fill with solid color if image is missing
